...
// because x is changed gloabally so both use the same x variable
/*:
...
greeting(greeting: nil, name: "Ryan")
greeting(greeting: "Hi there", name: "Ryan")
/*:
