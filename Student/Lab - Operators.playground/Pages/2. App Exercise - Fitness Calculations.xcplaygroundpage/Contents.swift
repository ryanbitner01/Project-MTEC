...
print(averageHRD)
// it differs because it doesn't remove the precision of decimal points because we are dividing doubles
...
let percentOfGoal = (goal / steps) * 10
