 ...
 */
print("its going to take off the decimal changing the value of the number because it doesn't divide evenly but they are both int values")
...
// the result has decimal points because you are dividing doubles it can include non whole numbers
...
print(even % 2)
print(odd % 2)
// if the remainder is 0 then the number is even else it's odd
