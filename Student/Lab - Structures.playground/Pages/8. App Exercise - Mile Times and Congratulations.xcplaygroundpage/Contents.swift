...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        let mile = distance / 1600
        return time / mile
    }
}

var run = RunningWorkout(distance: 1600, time: 1, elevation: 94)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("You have reached your step goal!")
            }
        }
    }
    var goal: Int
...
var workout = Steps(steps: 9999, goal: 10000)
workout.takeStep()
