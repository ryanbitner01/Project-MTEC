 ...
 */
let somePlace = GPS(longitude: 51.514004, latitude: 0.125226)
...
let favoriteBook = Book(title: "The Adventures of Huckleberry Fin", author: "Mark Twain", pages: 569, price: 15.99)
print("My favorite book is \"\(favoriteBook.title)\" it is by \(favoriteBook.author) it is \(favoriteBook.pages) pages long and it costs $\(favoriteBook.price).")
/*:
...
print(someonesHeight.heightCentimeters)
 ...
 */
var myHeight = Height(inches: 69)
print(myHeight.heightCentimeters)
