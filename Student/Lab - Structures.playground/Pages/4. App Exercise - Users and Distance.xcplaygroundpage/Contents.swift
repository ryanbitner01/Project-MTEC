 ...
 */
let ryan = User(name: "Ryan", age: 19, height: 69, weight: 120, activityLevel: 3)
print("My name is \(ryan.name) my height is \(ryan.height) inches and I weigh \(ryan.weight) pounds and my activity level is \(ryan.activityLevel).")
 ...
 */
let mile = Distance(meters: 1600.0)
 ...
 */
let distance2 = Distance(feet: 24)
print(distance2.distanceInMeters)
print(distance2.distanceInFeet)
