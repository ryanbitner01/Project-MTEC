 ...
 */
var comp1 = Computer(ram: 2, yearManufactured: 1999)
var comp2 = Computer(ram: 0, yearManufactured: 2010)

if let myComputer = comp1 {
    print(myComputer.ram, myComputer.yearManufactured)
}

if let myComputer = comp2 {
    print(myComputer.ram, myComputer.yearManufactured)
}
