 ...
 */
var numOfDays: [String: Int] = ["January": 31, "February": 28, "March": 31]
print(numOfDays)
 ...
 */
numOfDays.updateValue(29, forKey: "February")


/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let numInJan = numOfDays["January"] {
 ...
 */
if let colorsArray = newDict["Colors"], let last = colorsArray.last {
    print(last)
}
