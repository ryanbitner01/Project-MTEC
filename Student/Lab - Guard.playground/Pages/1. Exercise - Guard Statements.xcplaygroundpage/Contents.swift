...
func add(int1: Int?, int2: Int?) -> Int? {
    guard let myInt1 = int1, let myInt2 = int2 else {
        return nil
    }
    return myInt1 + myInt2
}

print(add(int1: nil, int2: 10))
print(add(int1: 0, int2: nil))
print(add(int1: 0, int2: 10))
/*:
...
func createUser() -> User? {
    guard let firstNameTextField = firstNameTextField.text, let lastNameTextField = lastNameTextField.text, let ageTextField = ageTextField.text  else { return nil }
 ...
 */
let theUser = createUser()

if let theUser = theUser {
    print("First Name: \(theUser.firstName) Last Name: \(theUser.lastName) Age: \(theUser.age)")
}
